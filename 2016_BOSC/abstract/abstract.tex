...
\author{
    ...
    Tiago Ant\~{a}o \footnote{Division of Biological Sciences, University of Montana, Montana, USA},
...
code table 25, covering Candidate Division SR1 and Gracilibacteria; and updates
to BioSQL to use foreign keys with SQLite3 databases.
