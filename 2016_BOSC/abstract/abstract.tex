...
\vspace{3mm}Biopython Project Update 2016}
\author{
    ...
    Wibowo\\
    Arindrarto\thanks{Sequencing Analysis Support Core, Leiden University Medical Center, Leiden, NL},
    Leighton Pritchard\textsuperscript{c},  % same as Peter, saves space
    Anuj Sharma\thanks{Department of Informatics and Telecommunications, University of Athens, Athens, Greece},
    Eric Rasche\thanks{Center for Phage Technology, Department of Biochemistry and Biophysics, Texas A\&M University, USA},
    Aaron Rosenfeld\thanks{Department of Biomedical Engineering, Science \& Health Systems, Drexel University, USA},
    Connor T.\\
    Skennerton\thanks{Division of Geological and Planetary Sciences, California Institute of Technology, Pasadena, CA, USA},
    Marco Galardini\thanks{EMBL-EBI, Wellcome Trust Genome Campus, Cambridge, UK},
...
Our website has moved from MediaWiki to GitHub Pages and is now under version
